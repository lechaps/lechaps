...
Tu as déjà remarqué comme un placard vide finit toujours… plein ?
Tu ranges, tu fais de la place, tu te dis : « Cette fois, je garde un peu d'air. »
...
**l'espace libre finit toujours par se remplir**.

## Pourquoi cette "loi" paraît si juste

* Plus on crée d'espace, plus on accumule.
* On pense que plus de place va régler nos problèmes, mais on étend simplement le désordre.
* Cela vaut pour nos objets, nos fichiers… et même notre temps libre.
* Bref : **le trop-plein est souvent une réponse naturelle au vide**.

En résumé : **le problème n'est pas la place, mais ce qu'on y met**.
Tant qu'on ne change pas nos habitudes, **plus d'espace = plus de bazar**.

## D'où vient vraiment la "loi de Douglas" ?
