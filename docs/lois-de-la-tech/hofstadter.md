...
La loi de Hofstadter n'est donc pas seulement une blague célèbre : c'est **une fenêtre sur la complexité**, un rappel que dès qu'un système comporte suffisamment de dépendances, **le futur cesse d'être calculable**.
