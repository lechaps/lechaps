...
Tu as déjà posé une question sur Internet et… personne ne t'a répondu ?
...
Ce principe, formulé comme une blague, résume parfaitement pourquoi les discussions en ligne explosent dès qu'une info bancale apparaît.
...
La loi de Cunningham ne vient pas d'un sociologue ou d'un psychologue… mais d'un développeur légendaire : **Howard G. "Ward" Cunningham**.
C'est l'homme qui a :

* créé le premier **wiki** (WikiWikiWeb, 1995),
* imaginé la collaboration ouverte avant tout le monde,
* cofondé les patterns de conception,
* **et signataire du *Manifesto for Agile Software* (2001)**.
...
* [Wiki Wiki Web](https://wiki.c2.com/?WikiWikiWeb){ target="_blank" }
* [Hacker News - technical debt](https://news.ycombinator.com/item?id=36636914){ target="_blank" }
* [Agile manifesto](https://agilemanifesto.org/){ target="_blank" }
