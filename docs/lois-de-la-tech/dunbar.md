...
Bref : **notre capacité relationnelle n'est pas infinie**.

## Pourquoi la loi de Dunbar est si parlante

* **Peu importe combien d'amis** Facebook ou de contacts LinkedIn tu accumule : tu ne peux entretenir des relations solides qu'avec un cercle restreint de personnes.
...
Internet n'augmente pas notre capacité relationnelle : **il réduit juste le coût d'entretien des liens faibles**. Nos réseaux deviennent plus larges… mais pas plus profonds.

Et ce constat ne concerne pas que notre vie personnelle : **on observe les mêmes limites dans les entreprises, les équipes performantes, les communautés en ligne et les organisations en télétravail**.  
Notre cerveau social a été conçu pour **la qualité du lien**, pas la quantité des interactions.

En somme, la loi de Dunbar nous rappelle que **notre richesse sociale ne se mesure pas au nombre de connexions… mais à la densité des liens que nous entretenons**.

### Références

* [Étude originale, Journal of Human Evolution, 1992](https://doi.org/10.1016/0047-2484%2892%2990081-J){ target="_blank" }
* [Dunbar, _Grooming, Gossip, and the Evolution of Language_, 1996](https://books.google.fr/books?id=AnJgtCIsSR0C&printsec=frontcover&hl=fr#v=onepage&q&f=false)
