...
Ce principe vient d’Internet, mais il s’applique à beaucoup plus large que la technique.
...
Trop strict ? Tout casse à la moindre anomalie.  
Trop tolérant ? Tout se dégrade jusqu'à l'incohérence.  
**L’équilibre, c’est d’être exigeant avec soi et indulgent avec les autres**.

Et c’est cet équilibre qui distingue les systèmes (et les humains) qui durent… des autres.
...
* [The Robustness Principle Reconsidered](https://www.internetsociety.org/grants-and-awards/postel-service-award/){ target="_blank" }
