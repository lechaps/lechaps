...
* continuer comme avant coûte plus cher,
* attendre aggrave le problème,
* et ne rien faire devient le vrai risque.

Une urgence saine éclaire la réalité. Une fausse urgence crée de la résistance.
...
* Tant qu'il n'y a pas un sentiment d'urgence ou d'évidence partagée, les habitudes gagnent presque toujours.
* On ne quitte pas le confort du connu sans une bonne raison — **il faut un feu sous les pieds pour commencer à marcher**.

Certaines organisations très matures savent initier des changements sans crise visible, non pas par peur, mais par lucidité stratégique, ambition collective ou culture d'apprentissage.

Mais ces cas restent l'exception : pour la majorité des transformations,
l'inconfort reste le déclencheur principal du mouvement.
...
* exagérée,
* mal expliquée,
* ou instrumentalisée pour imposer des décisions déjà prises.

Une urgence mal construite génère :

* du stress,
* de la défiance,
* et un repli défensif.

L'urgence efficace ne force pas l'adhésion :
elle rend le changement logique, presque évident.
...
Le rôle du leadership n'est donc pas de forcer le changement, mais de rendre l'immobilisme impossible à ignorer — avec lucidité, honnêteté et responsabilité.
