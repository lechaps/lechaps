...
La loi de Falkland ne prône pas l'inaction — elle défend le **timing**. Attendre, ce n'est pas reculer, c'est laisser la situation révéler la bonne décision. Quand les infos manquent, quand l'enjeu est lourd ou quand choisir maintenant crée plus de complexité qu'il n'en résout, la meilleure action est parfois de patienter. On ne gagne pas en décidant vite, mais en décidant **juste**.

On retrouve d'ailleurs cette philosophie dans le manifesto de la Continuous Architecture, qui encourage à différer les choix structurants tant que l'information n'est pas suffisante et que la décision n'est pas critique. Autrement dit, décider au dernier moment responsable (Last Responsible Moment) : ni trop tôt, au risque de figer inutilement, ni trop tard, lorsque le coût ou les conséquences deviennent irréversibles.
...
Selon la tradition, c'est dans les années 1640 qu'il aurait formulé cette maxime. Il la prononce à une période politique agitée, où l'empressement à trancher chaque question conduisait à des choix lourds de conséquences — parfois même à des conflits évitables.
