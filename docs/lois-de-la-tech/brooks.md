...
Sur le papier, ça paraît logique : « plus on est nombreux, plus on avance ».
Sauf qu'en réalité, c'est souvent l'inverse : plus de réunions, plus de coordination, plus de confusion… et un retard encore plus grand que celui qu'on voulait rattraper.
...
## Mais attention : la loi de Brooks n'est pas universelle

C'est un point souvent oublié : **la loi de Brooks ne dit pas qu'ajouter des personnes est toujours une mauvaise idée**.

Elle s'applique surtout quand :

* le projet est **déjà en retard**
* les tâches sont **fortement couplées**
...
La loi de Brooks reste **très vraie** :

* sur les projets legacy,
* dans les organisations mal structurées,
...
* c'est souvent un problème **d'architecture**,
* **d'organisation**,
* ou **de design du système humain**.

## D'où vient la loi de Brooks ?

La loi de Brooks a été formulée par **Fred Brooks**, ingénieur logiciel et manager de projet chez IBM dans les années 60.
En 1975, il publie le livre culte *The Mythical Man-Month*, où il tire les leçons du développement du système d'exploitation OS/360.
