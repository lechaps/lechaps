# UX : Tesler x Hick-Hyman x Norman
...
Ils forment un cadre simple, mais exigeant :
...
La loi de Hick-Hyman rappelle une limite humaine :
...
* cacher la complexité (Tesler),
* limiter les choix visibles (Hick-Hyman),
...
* et rester profondément médiocre.

Parce que ces lois ne sont pas des recettes.
Ce sont **des forces en tension**.

## Ce que ces trois principes disent vraiment

Pris ensemble, ils imposent une discipline claire :
...
Les lois UX ne servent pas à valider un design.
Elles servent à :

* détecter les angles morts,
* structurer les débats,
* forcer les arbitrages,
* assumer des choix inconfortables.

Un bon produit :

* viole parfois Hick-Hyman,
* expose parfois la complexité,
* introduit parfois de la friction.

Non par ignorance. Mais par intention.
